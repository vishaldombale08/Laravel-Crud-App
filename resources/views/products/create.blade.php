            ...
            <div class="col-md-10">
                <div class="card border-0 shadow-lg">
                    ...
                    <div class="card-body">
                        ...
                        @error('name')
                        <p class="invlid-feedback">{{$message}}</p>
                        @enderror
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text" name="description" class="form-control form-control-lg" placeholder="Description">{{old('description')}}</textarea>
                        </div>
                        <div class="mb-3">
